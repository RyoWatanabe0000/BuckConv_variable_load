...
circuit = BuckConverterEnv(dt=TIME_contorl, E_ini=E, R_ini=R_ini, L_ini=L, C_ini=C, career_amp=1, smooth_scale=50)
observation = circuit.reset(v_out_command=V_REF, resistance_change_rate=25000)
